...
CAREERS_URL = "https://7vals.simplicant.com/"
REQUEST_TIMEOUT_SECONDS = 10

# Same Simplicant-hosted pattern as Mindstorm Studios and PakWheels: the
# careers page server-renders every opening as an <a class="list-group-
# item">, with title/location inline. Some postings repeat across the
...
@register
class SevenValsScraper(Scraper):
    company_name = "7Vals"
