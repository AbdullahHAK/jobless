...
apply directly instead of checking 16+ company sites individually.
...
Currently scraping 16 companies: Arbisoft, Devsinc, Folio3, Confiz, Codup, Tkxel, 10Pearls,
Contour Software, VentureDive, NetSol Technologies, Abacus Consulting, Kualitatem, EurosHub,
InvoZone, Nextbridge, and Trango Tech. Each scraper picks whatever data source is actually cleanest for
...
Actions workflow (`smoke-test.yml`) since it does a real scrape of all 16 companies' live
