...
apply directly instead of checking 18+ company sites individually.
...
Currently scraping 18 companies: Arbisoft, Devsinc, Folio3, Confiz, Codup, Tkxel, 10Pearls,
Contour Software, VentureDive, NetSol Technologies, Abacus Consulting, Kualitatem, EurosHub,
InvoZone, Nextbridge, Trango Tech, CureMD, and Genetech Solutions. Each scraper picks whatever data source is actually cleanest for
...
Actions workflow (`smoke-test.yml`) since it does a real scrape of all 18 companies' live
