...
apply directly instead of checking 26+ company sites individually.
...
Currently scraping 26 companies: Arbisoft, Devsinc, Folio3, Confiz, Codup, Tkxel, 10Pearls,
...
KalSoft, Smart Working Solutions, Bazaar Technologies, NayaPay, Careem, and Prime System
Solutions. Each scraper picks whatever data source is actually cleanest for
...
Actions workflow (`smoke-test.yml`) since it does a real scrape of all 21 companies' live
